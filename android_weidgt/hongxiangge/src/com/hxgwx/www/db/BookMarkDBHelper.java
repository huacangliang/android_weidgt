...
public class BookMarkDBHelper {
	...
	private static BookMarkDBHelper db;

	private BookMarkDBHelper(Context context) {
		this.context = context;
	}

	private static String DBNAME = "com.hxgwx.bookmark";
	...
	public DbUtils createDb() {
		if (dbManager == null) {
			dbManager = DbUtils.create(context, DBNAME, DBVERSION,
	...
	public static BookMarkDBHelper getInstance(Context context) {
		if (db == null) {
			db = new BookMarkDBHelper(context);
		}
		return db;
	}
